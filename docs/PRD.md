...
- 支持格式：
  ...
  - 字段顺序要求：
    1. 知识点（必填，最多100字）
    2. 答案（必填，最多500字）
    3. 创建时间（可选，支持“YYYY-MM-DD”或“YYYY-MM-DD HH:mm:ss”，如只填日期会自动补全为00:00:00）
    4. 复习次数（可选，默认0）
    5. 下次复习时间（可选，支持“YYYY-MM-DD”或“YYYY-MM-DD HH:mm:ss”，如只填日期会自动补全为00:00:00）
...
- 界面设计：
  ...
  - 说明文字：
    ...
    - 时间格式：支持“YYYY-MM-DD”或“YYYY-MM-DD HH:mm:ss”，如只填日期会自动补全为00:00:00
    ```
  - 文件选择区域：
    - 文件选择按钮：点击选择本地文件
    - 文件信息显示：显示已选择的文件名和大小
